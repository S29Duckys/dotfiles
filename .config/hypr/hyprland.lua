...
hl.config({
    general = {
        ...
        resize_on_border = true,    -- drag sur les bords pour redimensionner
        allow_tearing    = false,   -- voir https://wiki.hypr.land/Configuring/Advanced-and-Cool/Tearing/
        layout = "dwindle",
    },
    decoration = {
        rounding       = 10,
...
-- "Smart gaps" : pas de gaps quand une seule fenêtre
...
hl.config({
    input = {
        ...
        kb_rules   = "",
        follow_mouse = 1,
        sensitivity  = 0,   -- -1.0 à 1.0, 0 = aucune modification
        touchpad = {
...
-- Déplacer la fenêtre avec SUPER + SHIFT + flèches
...
-- Ignore les demandes de maximisation des apps
hl.window_rule({
...
-- Fenêtre hyprland-run en bas de l'écran
hl.window_rule({
